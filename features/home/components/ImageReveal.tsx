...
function ImageReveal() {
  ...
  return (
    <section ref={containerRef} onMouseMove={handleMove} className='relative max-w-6xl mx-auto p-4'>
      {list.map((item) => (
        <div
          key={item.label}
          ...
          className='w-full py-5 cursor-pointer hover:bg-primary/10 text-center flex justify-between items-center text-primary border-b dark:border-neutral-800 border-neutral-50 last:border-none'
        >
